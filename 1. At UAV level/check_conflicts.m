function [Nav_in_conflit, Land_in_conflit, Track_in_conflit, statesinconflict_Nav, statesinconflict_Land, statesinconflict_Track] = ...
                                                check_conflicts(pol_1, pol_2, pol_3, constraint_table, Proba_sys, Proba_detect_obs, Camera_failure, P_bat)
%%intialisation 
P_battery_RTH = 0.32; % energy need to to RTH is 32% of the full.
